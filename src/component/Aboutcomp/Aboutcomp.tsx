    ...
    <div className="flex flex-col gap-6 flex-1 w-full">
      <div className="bg-gray-50 p-4 rounded-xl shadow">
        ...
        <p className="text-gray-600">
          ...
          coding experience, specializing in React, Next.js, and Node.js. I
          excel at building high-performance web applications and enjoy solving
    ...
    <div className="flex flex-col gap-6 w-full">
      ...
      <div className="bg-gray-50 p-4 rounded-xl shadow w-full">
        ...
        <p className="text-gray-600">
          ...
          coding experience, specializing in React, Next.js, and Node.js. I
          excel at building high-performance web applications and enjoy
