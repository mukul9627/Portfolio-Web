...
const Aboutcomp = () => {
    return (
        <>
          <div className="flex flex-col lg:flex-row gap-6 bg-white rounded-lg p-6 max-w-7xl">
      {/* Left Column - Info */}
      <div className="flex flex-col md:flex-row gap-6 p-6 bg-white rounded-2xl shadow-md max-w-6xl mx-auto">
  ...
  />
        ...
        <h2 className="mt-4 text-2xl font-bold">Mukul sharma</h2>
        <p className="text-gray-500">Software Engineer</p>
        <div className="flex gap-4 mt-4">
          <a href="mailto:example@example.com" className="p-2 rounded-lg bg-gray-100 hover:bg-gray-200">
            <Mail />
          </a>
          <a href="https://github.com/" target="_blank" className="p-2 rounded-lg bg-gray-100 hover:bg-gray-200">
            <Github />
          </a>
          <a href="https://linkedin.com/" target="_blank" className="p-2 rounded-lg bg-gray-100 hover:bg-gray-200">
            <Linkedin />
          </a>
        </div>
      </div>
      ...
      <div className="flex flex-col gap-6 flex-1">
        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="bg-gray-50 p-4 rounded-xl">
              <h4 className="font-medium mb-2">Languages & Frameworks</h4>
            ...
            <div className="bg-gray-50 p-4 rounded-xl">
              ...
              <div className="flex flex-wrap gap-2">
                {['Git', 'Docker', 'AWS', 'GraphQL', 'REST APIs'].map((tech) => (
                  <span key={tech} className="bg-gray-200 text-sm px-3 py-1 rounded-full">{tech}</span>
                ))}
              </div>
            </div>
          </div>
      ...
      <div className="flex-1 min-w-0 card-shadow shadow p-4 overflow-auto">
    ...
    <section className="max-w-7xl flex flex-col px-6 py-8">
      {/* Row */}
      <div className="flex flex-col lg:flex-row gap-6 w-full max-w-7xl ">
        ...
        <div className="w-full lg:w-1/2">
          ...
          <div className="flex flex-col sm:flex-row gap-6 w-full">
            {[...Array(3)].map((_, idx) => (
              <div key={idx} className="p-4 rounded-lg bg-white shadow w-full sm:w-1/3">
                <h4 className="font-semibold tracking-tight text-sm line-clamp-1 flex items-center text-black">
                  ...
                  >
                    ...
                    <span className="line-clamp-1 ml-1 text-xs text-black">vite-serve</span>
                  </a>
                </h4>
                <p className="text-sm text-gray-500 mt-2 leading-snug line-clamp-3">
                  A VS Code extension designed to streamline your React development workflow by starting your existing projects with Vite with no extra configuration.
                </p>
